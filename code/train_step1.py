...
#amp_ratio_Graph=net.brightness_predict_net(img_input_Graph,inp_iso_Graph,inp_t_Graph)
...
loss_SSIM_Graph = 1 - tf.image.ssim_multiscale(Yhat_im_output_Graph,Y_im_gt_Graph,max_val=1.0)
...
with tf.Session()  as sess:
    ...
    if ckpt:
        ...
        ckpt = tf.train.get_checkpoint_state(checkpoint_dir+'pre/')
        saver.restore(sess, ckpt.model_checkpoint_path)
